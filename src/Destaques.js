                ...
                <div className="grid grid-cols-2 gap-6 md:grid-cols-3 xl:grid-cols-4">
                  ...
                  <div className="flex flex-col items-center p-4 bg-white shadow-md rounded-2xl">
                    ...
                    <div className="flex flex-col w-full gap-2 mt-4">
                      <button className="w-full px-4 py-2 text-sm font-bold text-white bg-teal-600 rounded-md hover:bg-teal-700">
                        Detalhes
                      </button>
                      <button className="flex items-center justify-center w-full gap-2 px-4 py-2 text-sm font-bold text-white transition bg-green-500 rounded-md hover:bg-green-600">
